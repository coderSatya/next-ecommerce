...
import { decreaseQuantity, increaseQuantity, deleteProduct } from "@/redux-toolkit/slices/shoppingSlices";
...
const CartItem = () => {
  ...
  return (
    <div className="flex flex-col gap-y-2">
      <div className="hidden lg:inline-flex items-center justify-between font-semibold bg-gray-300 p-2">
